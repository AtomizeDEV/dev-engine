...
export default class BaseController extends Controller {
    ...
    /**
     * Transitions to a specified route within the '@atomizedev/fleetops-engine' engine.
     *
     * This action is a wrapper around the `transitionToEngineRoute` method of the `universe` service (or object),
     * specifically targeting the '@atomizedev/fleetops-engine'. It allows for easy transitioning to routes
     * within this engine, abstracting away the need to repeatedly specify the engine name.
     *
     * @param {string} route - The route within the '@atomizedev/fleetops-engine' to transition to.
     ...
     *
     * @example
     * // To transition to the 'management.fleets.index.new' route within the '@atomizedev/fleetops-engine'
     * this.transitionToRoute('management.fleets.index.new');
     */
    @action transitionToRoute(route, ...args) {
        return this.universe.transitionToEngineRoute('@atomizedev/dev-engine', route, ...args);
    }
}
